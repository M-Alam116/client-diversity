      ...
      <div className="w-full sm:w-[65%] flex-col mx-auto py-[4rem]">
        ...
        <div className="flex flex-col gap-[1rem] mt-[2rem]">
          ...
          <p className="">
            ...
            - Through social effort, supermajority.info (lead by Sonic) gathers
            <span className="font-[800]"> self-reported</span> client breakdown
            data and weighted against how many validators each entity has. While
            this doesn’t capture data on the entire network, the marketshare
            from the entities involved is substantial enough to be considered
            representative.
          </p>
        </div>
      </div>
